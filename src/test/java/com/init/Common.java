...
public class Common {
	...
	*/
	...
	public static void windowhorizontalscroll(WebDriver driver) {
	...
	public static void logcase(String msg) {
	    ...
	    Reporter.log("<strong> <h3 style=\"color:Blue\"> " + msg
	      + "</h3> </strong>");
	    }
	...
	public static void makeScreenshot(WebDriver driver, String screenshotName) {
		...
		try {
			/*
			 * String reportFolder = "target" + File.separator + "failsafe-reports" +
